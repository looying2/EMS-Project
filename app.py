...
if user_role == "Doctor":
    ...
    with tab_records:
        ...
        _body_svg = (
            '<svg viewBox="0 0 100 220" width="80" xmlns="http://www.w3.org/2000/svg">' +
            '<ellipse cx="50" cy="14" rx="10" ry="12" fill="#C8D8E8" stroke="#9BB5CC" stroke-width="0.7"/>' +
            '<rect x="46" y="25" width="8" height="7" rx="2" fill="#C8D8E8"/>' +
            f'<path d="M34,32 Q29,35 28,43 L27,72 Q27,76 31,77 L48,77 L52,77 L69,77 Q73,76 73,72 L72,43 Q71,35 66,32 Z" fill="{_tr}" fill-opacity="0.75"/>' +
            f'<path d="M28,33 Q23,37 22,45 L21,62 Q21,67 25,68 L32,68 Q36,66 37,61 L37,44 Q36,37 32,33 Z" fill="{_la}" fill-opacity="0.75"/>' +
            f'<path d="M72,33 Q77,37 78,45 L79,62 Q79,67 75,68 L68,68 Q64,66 63,61 L63,44 Q64,37 68,33 Z" fill="{_ra}" fill-opacity="0.75"/>' +
            '<path d="M32,76 L68,76 Q72,78 72,83 L71,90 Q69,93 64,94 L36,94 Q31,93 29,90 L28,83 Q28,78 32,76 Z" fill="#A8C4D8"/>' +
            f'<path d="M29,92 Q26,97 26,106 L26,150 Q27,155 31,156 L39,156 Q43,154 44,149 L44,105 Q43,96 39,92 Z" fill="{_ll}" fill-opacity="0.75"/>' +
            f'<path d="M71,92 Q74,97 74,106 L74,150 Q73,155 69,156 L61,156 Q57,154 56,149 L56,105 Q57,96 61,92 Z" fill="{_rl}" fill-opacity="0.75"/>' +
            f'<ellipse cx="35" cy="160" rx="10" ry="4" fill="{_ll}" fill-opacity="0.5"/>' +
            f'<ellipse cx="65" cy="160" rx="10" ry="4" fill="{_rl}" fill-opacity="0.5"/>' +
            '</svg>'
        )
